...
- Supabase PostgreSQL (extend existing `player_pokemon` table) (007-pokemon-move-hp-setup)
...
## Recent Changes
- 007-pokemon-move-hp-setup: Added JavaScript (ES6+), Node.js 18+ + Next.js 14.x, React 18.x, @supabase/supabase-js ^2.89.0
